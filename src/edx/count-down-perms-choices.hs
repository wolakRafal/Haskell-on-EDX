...
-- function that returns all choices from a list, which are given by all possible ways of selecting 
-- zero or more elements in any order.
choices 			:: [a] -> [[a]]
